...
6. **Production Build & Start (Optional)**:
...
```text
ai-devtools-zoomcamp-2k26/
├── README.md                           # Repository documentation
├── .gitignore                          # Root Git ignore rules
└── placement-tracker/                  # Placement & Internship Tracker project
...
In adherence to the [SPEC.md](placement-tracker/SPEC.md) scope boundaries, the following items are intentionally excluded from V1:
